...
public class OdnoklassnikiOauth2 {
    private static final Logger log = LoggerFactory.getLogger(OdnoklassnikiOauth2.class);
    private String appId, scope, redirectUri, accessToken, appSecret, appKey;
    public OdnoklassnikiOauth2(String appId, String appSecret, String appKey, String redirectUri, String scope) {
        this.appId = appId;
        this.scope = scope;
    ...
    public String getLoginRedirectURL(){
        return String.format("http://www.odnoklassniki.ru/oauth/authorize?"
                + "client_id=%s&scope=%s&response_type=code&redirect_uri=%s", appId, scope, redirectUri);        
    }
    public String getAccessToken(String code){
        String url=String.format("http://api.odnoklassniki.ru/oauth/token.do?code=%s&redirect_uri=%s&grant_type=authorization_code"+
    ...
    public JSONObject makeAPICall(String method, HashMap<String, Object> params){
        if(accessToken==null)
            return null;        
        if(params==null)
        ...
        String url=String.format("http://api.odnoklassniki.ru/api/%s?%s", method, createQueryString(params));
    ...
    public static String createQueryString(HashMap<String, Object> map){
        String result="";
